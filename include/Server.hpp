...
class Server
{
	...
	public:
		...
		void broadcast(const std::string& msg, int exclude_fd = -1); //idk if i shuld use this
		...
		//void	sendToChannel(std::string msg, std::string channel);
};
